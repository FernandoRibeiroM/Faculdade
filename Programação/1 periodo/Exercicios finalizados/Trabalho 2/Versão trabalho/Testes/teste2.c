...
void cima(char tipo, char cor, char tabuleiro[][8], int x);
...
{
    int i, j, contador;
    char preto = 'P', branco = 'B', recursao = 'R', n_recursao = 'N';
    if (tipo == 'S')
    {
        if (cor == 'P')
        {
        ...
        for (i = 0; i < 8; i++)
        {
            ...
            for (j = 0; j < 8; j++)
            {
                ...
                if (cor == 'P')
                {
                    if (tabuleiro[i][j] == 'P')
                    {
                        if (tabuleiro[contador--][j] == 'B')
                        {
                            if (tabuleiro[contador--][j] == ' ')
                            {
                                tabuleiro[contador][j] = 'X';
                            }
                            else if (tabuleiro[contador--][j] == 'B')
                            {
                                cima(recursao, preto, tabuleiro[8][8], 8);
                            }
                        }
                    }
                }
                else
                {
                    if (tabuleiro[i][j] == 'B')
                    {
                        if (tabuleiro[contador--][j] == 'P')
                        {
                            if (tabuleiro[contador--][j] == ' ')
                            {
                                tabuleiro[contador][j] = 'X';
                            }
                            else if (tabuleiro[contador--][j] == 'P')
                            {
                                cima(recursao, branco, tabuleiro[8][8], 8);
                            }
                        }
                    }
                }
