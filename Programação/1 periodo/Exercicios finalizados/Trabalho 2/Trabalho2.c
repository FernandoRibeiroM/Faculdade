...
//essas funções abaixo não funcionam, eu as mantive aqu pois assim ao menos eu mostro que tentei
void direita(char cor, char tabuleiro[][8], int x);
void esquerda(char cor, char tabuleiro[][8], int x);
void cima(char cor, char tabuleiro[][8], int x);
void baixo(char cor, char tabuleiro[][8], int x);
void direita_baixo(char cor, char tabuleiro[][8], int x);
void direita_cima(char cor, char tabuleiro[][8], int x);
void esquerda_cima(char cor, char tabuleiro[][8], int x);
...
int main()
{
    ...
    printf("As minhas funcoes do jogo nao funcionam, por este motivo eu deixei comentado a parte que deveria rodar o jogo, mas eu nao deixei de forma que fosse funcional,porque perdi muito tempo tentando solucionar as funcoes\n");
    //As minhas funcoes do jogo não funcionam, por este motivo eu deixei comentedo a parte quuedeveria rodar o jogo
    system("pause");
    system("cls");

    //O tabuleiro funciona, por isso apenas irei apresentar ele
...
//as funções abaixo não funcionam, eu as mantive aqu pois assim ao menos eu mostro que tentei
void direita(char cor, char tabuleiro[][8], int x)
{
    int i, j, k;
    if (cor == 'P')
    {
        for (i = 0; i < 8; i++)
        {
            for (j = 0; j < 8; j++)
            {
                ...
                if (tabuleiro[i][j] == 'P')
                {
                    while ((tabuleiro[i][k] != 'X') || (tabuleiro[i][k] != 'P') || (k >= 8) || (k < 0))
                    {
                        k++;
                        if (tabuleiro[i][k] == ' ')
                        {
    ...
    else if (cor == 'B')
    {
        for (i = 0; i < 8; i++)
        {
            for (j = 0; j < 8; j++)
            {
                ...
                if (tabuleiro[i][j] == 'B')
                {
                    while ((tabuleiro[i][k] != 'X') || (tabuleiro[i][k] != 'B') || (k < 8) || (k >= 0))
                    {
                        k++;
                        if (tabuleiro[i][k] == ' ')
                        {
    ...
    if (cor == 'P')
    {
        for (i = 0; i < 8; i++)
        {
            for (j = 0; j < 8; j++)
            {
                ...
                if (tabuleiro[i][j] == 'P')
                {
                    while ((tabuleiro[k][l] != 'X') || (tabuleiro[k][l] != 'P') || (k >= 8) || (k < 0) || (l >= 8) || (l < 0))
                    {
                        k++;
                        l++;
                        if (tabuleiro[i][k] == ' ')
    ...
    else if (cor == 'B')
    {
        for (i = 0; i < 8; i++)
        {
            for (j = 0; j < 8; j++)
            {
                ...
                if (tabuleiro[i][j] == 'B')
                {
                    while ((tabuleiro[k][l] != 'X') || (tabuleiro[k][l] != 'B') || (k < 8) || (k >= 0))
                    {
                        k++;
                        l++;
                        if (tabuleiro[i][k] == ' ')
...
void esquerda_baixo(char cor, char tabuleiro[][8], int x)
{
    int i, j, k, l;
    if (cor == 'P')
    {
